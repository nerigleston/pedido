Este é um projeto de página da web simples que permite fazer uma proposta de casamento interativa. A página exibe uma mensagem perguntando "Quer casar comigo?" e oferece duas opções: "Sim" e "Não". 
